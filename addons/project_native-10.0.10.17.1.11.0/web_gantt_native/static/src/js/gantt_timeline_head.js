...
var GanttTimeLineHead = Widget.extend({
    ...
    start: function(){
        ...
        if (this.timeType == 'month_week') {
            ...
            // _.map( this.first_scale, function (head_first, key_name ) {
            //     // console.log(key_name)
            //
            //     var head_first_width = self.timeScale*head_first.length;
            //
            //     var div_cell = $('<span class="task-gantt-top-column"></span>');
            //     div_cell.css({ width: head_first_width + "px" });
            //     div_cell.append($('<span class="task-gantt-scale-month-text">'+key_name+'</span>'));
            //
            //     el_scale_primary.append(div_cell);
            //
            //
            //
            //     _.map( head_first, function (head_second) {
            //         // console.log(head_second.week)
            //
            //         div_cell = $('<span class="task-gantt-bottom-column">' + head_second.week + '</span>');
            //         div_cell.css({width: self.timeScale + "px"});
            //
            //
            //         el_scale_secondary.append(div_cell);
